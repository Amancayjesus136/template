...
<head>
  ...
  <title>Jesús Amancay Acuña</title>
...
@stack('scripts')
 ...
 <!-- Vendor JS Files -->
 <script src="{{ asset('assets3/vendor/purecounter/purecounter_vanilla.js') }}"></script>
  ...
  <script src="{{ asset('assets3/vendor/typed.js/typed.umd.js') }}"></script>
  <script src="{{ asset('assets3/vendor/waypoints/noframework.waypoints.js') }}"></script>
