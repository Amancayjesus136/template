...
<body class="img js-fullheight" style="background-image: url( {{ asset('assets2/images/bg.jpg') }} );">
                    ...
                    <div class="login-wrap p-0">
                        ...
                        <form action="{{ route('login') }}" method="POST" class="signin-form">
                            ...
                            <div class="form-group">
                                <input type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="Gmail" required>
                            </div>
